...
{{--                                        <input type="text" class="form-control" id="propertyDescription" name="property_date_of_construction">--}}
                                ...
                                <div class="col-lg-6 col-xl-6">
                                    <div class="my_profile_setting_input ui_kit_select_search form-group">
                                        ...
                                        {{Form::select('property_location', [ 'Kampala' => ['kampala' => 'kampala'],'Masindi' => ['Mbale' => 'Mbale'],]  , null, ['placeholder' => 'Location','class'=>'d-block rounded-0 selectpicker text-capitalize'])}}
...
{{--                                            <option value="kajjasii">Kajjasi</option>--}}
