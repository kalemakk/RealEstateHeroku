                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($getall as $prop)
                                            <tr>
                                                ...
                                                <td><span class="status_tag badge2">NotYetAquired{{$prop->id}}</span></td>
                                                    @else
                                                ...
                                                <td>
                                                    <ul class="view_edit_delete_list mb0">
                                                        <li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="Edit"><a href="{{url('property')}}/{{$prop->id}}/edit"><span class="flaticon-edit"></span></a></li>
                                                        <form action="{{ route('property.destroy',$prop->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"><li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="Delete"><span class="flaticon-garbage"></span></li></button>

{{--                                                            <button type="submit" data-toggle="modal" data-target="#exampleModal"><li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="Delete"><span class="flaticon-garbage"></span></li></button>--}}
...
{{--                                                                            <div class="text-thm3">--}}
{{--                                                                                Property Name:<span class="text-thm6">{{$prop->id}}{{$prop->property_name}}</span><br>--}}
